...
def generate_sets(filename):
    ...
    _features = [df.Entire_home, df.accommodates, df.scenery, df.bedroom, df.beds, df.guests,
                 df.park, df.house_ln, df.superhost,

                 df.accommodates_s, df.scenery_s, df.bedroom_s, df.accom_bedroom, df.park_scenery, df.bedroom_for_each,
