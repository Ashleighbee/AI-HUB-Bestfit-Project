...
features_c = [df.subway, df.bus_stop, df.park, df.scenery, df.accommodates, df.bathroom, df.bedroom, df.beds, df.guests,
            df.num_of_review, df.review_score, df.Entire_home, df.host_response_rate, df.superhost, df.crime_rate]
features_b = [df_b.subway, df_b.bus_stop, df_b.park, df_b.scenery, df_b.accommodates, df_b.bathroom, df_b.bedroom, df_b.beds, df.guests,
            df.num_of_review, df.review_score, df.Entire_home, df.host_response_rate, df.superhost, df.crime_rate
...
def forest_test():
    ...
    print('Accuracy:\t', reg_Forest.score(X_test_b, y_test_b))
